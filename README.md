...
spectrum disorder (ASD) genetic-risk prediction. The accompanying paper is
built under [`paper/`](paper/).

The original research proposal lives in
[`JaanaLabs_239318J_258222U_258251G.md`](JaanaLabs_239318J_258222U_258251G.md)
and is preserved unchanged for historical context.
...
paper/                     # LaTeX manuscript + Makefile
```
